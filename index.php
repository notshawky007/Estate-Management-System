        ...
        <div class="container py-1">
          <div class="row align-items-center">
            <div class="col-8 col-md-8 col-lg-4">
              <h1 class="mb-0"><a href="index.html" class="text-white h2 mb-0"><strong>Dtu<span class="text-danger">.</span></strong></a></h1>
            </div>
      ...
      <div class="row">
          <div class="col-md-6 col-lg-4 mb-5 mb-lg-5">
            <div class="team-member">
              ...
              <div class="text">
                ...
                <h2 class="mb-2 font-weight-light text-black h4">Shawky</h2>
                <span class="d-block mb-3 text-white-opacity-05">Agent</span>
                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit.</p>
                <p>
                  <a href="https://www.facebook.com/mostafa.gabr.102/" class="text-black p-2"><span class="icon-facebook"></span></a>
                  <a href="https://github.com/notshawky007" class="text-black p-2"><span class="icon-github"></span></a>
                  <a href="https://www.linkedin.com/in/notshawky007/" class="text-black p-2"><span class="icon-linkedin"></span></a>
                </p>
              </div>
          ...
          <div class="col-md-6 col-lg-4 mb-5 mb-lg-5">
            <div class="team-member">
              ...
              <div class="text">
                ...
                <h2 class="mb-2 font-weight-light text-black h4">Techno</h2>
                <span class="d-block mb-3 text-white-opacity-05">Agent</span>
                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit.</p>
                <p>
                  <a href="#" class="text-black p-2"><span class="icon-facebook"></span></a>
                  <a href="#" class="text-black p-2"><span class="icon-github"></span></a>
          ...
          <div class="col-md-6 col-lg-4 mb-5 mb-lg-5">
            <div class="team-member">
              ...
              <div class="text">
                ...
                <h2 class="mb-2 font-weight-light text-black h4">Yahia</h2>
                <span class="d-block mb-3 text-white-opacity-05">Agent</span>
                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit.</p>
                <p>
                  <a href="#" class="text-black p-2"><span class="icon-facebook"></span></a>
          ...
          <div class="col-md-6 col-lg-4 mb-5 mb-lg-5">
            <div class="team-member">
              ...
              <div class="text">
                ...
                <h2 class="mb-2 font-weight-light text-black h4">Rizk</h2>
                <span class="d-block mb-3 text-white-opacity-05">Agent</span>
                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit.</p>
                <p>
                  <a href="#" class="text-black p-2"><span class="icon-facebook"></span></a>
          ...
          <div class="col-md-6 col-lg-4 mb-5 mb-lg-5">
            <div class="team-member">
              ...
              <div class="text">
                ...
                <h2 class="mb-2 font-weight-light text-black h4">Shaban</h2>
                <span class="d-block mb-3 text-white-opacity-05">Agent</span>
                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit.</p>
                <p>
                  <a href="#" class="text-black p-2"><span class="icon-facebook"></span></a>
          ...
          <div class="col-md-6 col-lg-4 mb-5 mb-lg-5">
            <div class="team-member">
              ...
              <img src="images/person_6.jpg" alt="Image" class="img-fluid rounded mb-4">

              <div class="text">

                <h2 class="mb-2 font-weight-light text-black h4">Rashed</h2>
                <span class="d-block mb-3 text-white-opacity-05">Agent</span>
                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit.</p>
                <p>
                  <a href="#" class="text-black p-2"><span class="icon-facebook"></span></a>
